...
if(isset($_POST['submit'])){
	...
	if($msg==''){
		if(isset($_GET['id']) && $_GET['id']!=''){
			mysqli_query($conn,"update sub_categories set categories_id='$categories' and sub_categories='$sub_categories' where id='$id'");
		}else{
                     ...
                     <div class="card">
                        ...
                        <form method="post">
                            <div class="card-body card-block">
							   ...
							   <?php $res=mysqli_query($conn,"select * from categories where status='1'");
							   ...
							   <div class="form-group">
									...
									<input type="text" name="sub_categories" placeholder="Enter sub_categories" class="form-control" required value="<?php echo $sub_categories?>">
								</div>
