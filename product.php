...
?>
 ...
 <!-- Start Bradcaump area -->
        <div class="ht__bradcaump__area" style="background:url(images/bg/background 4.jpg) no-repeat scroll center center / cover ;">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <ul class="pro__details__tab" role="tablist">
                            <li role="presentation" class="description active"><a href="#indication" role="tab" data-toggle="tab">Indication</a></li>
                        </ul>
