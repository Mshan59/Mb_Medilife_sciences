                                ...
                                <div class="wishlist-table table-responsive">
                                    <table>
                                        ...
                                        <tbody>
                                            ...
                                            product.name,product.image from order_details,product ,
                                            `order` where order_details.order_id='$order_id' and `order`
                                            .user_id='$uid' and order_details.product_id=product.id");
											$total_price=0;
