...
// $meta_title="Mbmedi lifesciences";
// $meta_desc="Mbmedi lifesciences";
// $meta_keyword="Mbmedi lifesciences";
...
<head>
    ...
    <title>MBMEDI LIFESCIENCES</title>
    ...
    <link rel="icon" href="./images/logo/mainlogo.png" type="image/icon type">
...
<body>
    ...
    <div class="wrapper">
        <header id="htc__header" class="htc__header__area header--one" style="background:#ADEFD1FF;">
                    ...
                    <div class="row">
                        <div class="menumenu__container clearfix">
                            <div class="col-lg-2 col-md-2 col-sm-3 col-xs-5">
                                <div class="logo">
                                     <a href="index.php"><img src="images/logo/mainlogo.png" alt="logo images"></a>
                                </div>
                            </div>
                            <div class="col-md-7 col-lg-7 col-sm-6 col-xs-3">
                                <nav class="main__menu__nav hidden-xs hidden-sm">
                                    <ul class="main__menu">
										...
										?>
                                          <li><a href="our_team.php">Teams</a></li>
                                            <li><a href="offer.php">Offer <sup style="color:red;">New</sup></a></li>
                            ...
                            <div class="col-md-2 col-lg-3 col-sm-4 col-xs-4">
                                <div class="header__right">
									...
									<div class="header__search search search__open <?php echo $class?>">
                                        <a href="#"><i class="icon-magnifier icons" style="color:#fff;"></i></a>
                                    </div>
												...
												<ul class="navbar-nav mr-auto">
												  <li class="nav-item dropdown">
													...
													<div class="dropdown-menu" aria-labelledby="navbarDropdown">
													  <a class="dropdown-item" style="color:yellow;" href="my_order.php">My Order</a>
													  <a class="dropdown-item" style="color:yellow;" href="profile.php">Profile</a>
													  <!-- <div class="dropdown-divider"></div> -->
													  <a class="dropdown-item" style="color:yellow;" href="logout.php">Logout</a>
													</div>
												  </li>
                                    ...
                                    <div class="htc__shopping__cart">
										...
										?>
										<a href="wishlist.php" class="mr15"><i class="icon-heart icons" style="color:#fff;" ></i></a>
                                        <a href="wishlist.php"><span class="htc__wishlist"><?php echo $wishlist_count?></span></a>
										<?php } ?>
                                        <a href="cart.php"><i class="icon-handbag icons" style="color:#fff;"></i></a>
